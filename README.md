...
**Live demo:** <https://koksasa.github.io/sheet-metal-unfolder/>
...
- Press-brake Y-axis calculator and bend table

Everything runs locally in the browser — no installation, no server, works offline.

## License

Licensed under **CC BY-NC 4.0** — free for personal and educational use with attribution to the author (**KoksaSa**). **Commercial use is not allowed.**
