...
const STRINGS = {
  ru: {
    ...
    arcTool: 'Дуга',
    arcToolHint: 'Радиусный гиб: нарисуйте дугу заданного радиуса — она делится на сегменты; после гибки всех сегментов получается нужный радиус (углы между сегментами считаются автоматически)',
  ...
  en: {
    ...
    arcTool: 'Arc',
    arcToolHint: 'Radius bend: draw an arc of the given radius — it is split into segments; bending all segments yields the required radius (angles between segments are computed automatically)',
