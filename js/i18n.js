...
const STRINGS = {
  ru: {
    ...
    // v5.9: касание контура профиля и пуансона после гиба
    punchTouchTitle: 'Контур профиля касается пуансона',
    punchTouchAtStroke: 'при гибке (в конце хода)',
    punchTouchAtRest: 'после гиба (пуансон поднят)',
    punchTouchHint: 'Смените/сдвиньте инструмент или измените радиус гиба',
  ...
  en: {
    ...
    // v5.9: profile contour touches the punch after the bend
    punchTouchTitle: 'Profile contour touches the punch',
    punchTouchAtStroke: 'during bending (end of stroke)',
    punchTouchAtRest: 'after the bend (punch raised)',
    punchTouchHint: 'Change/move the tool or adjust the bend radius',
