...
const STRINGS = {
  ru: {
    ...
    drawProfile: 'Профиль инструмента',
    drawProfileHint: 'Кликните по холсту чтобы нарисовать профиль',
    clickToDraw: 'Кликните чтобы нарисовать профиль',
    needMorePoints: 'Нужно минимум 3 точки',
    save: 'Сохранить',
  ...
  en: {
    ...
    drawProfile: 'Tool profile',
    drawProfileHint: 'Click on canvas to draw profile',
    clickToDraw: 'Click to draw profile',
    needMorePoints: 'Need at least 3 points',
    save: 'Save',
