...
// v5.9: ХОД пуансона при гибке — 8 мм (было ~15 мм: T/2 + 14 покоя).
// Пуансон останавливается ровно на 8 мм выше конечной точки касания
// дуги гиба — ход всегда одинаков, независимо от толщины/радиуса.
const SIM_PUNCH_TRAVEL    = 8;    // ход пуансона при гибке (мм)
